...
public:
    ...
    static const size_t nbytes = 32; // to pass compiler (TODO: remove host code or completely rewrite)
    typedef byte pow_t[256/8];

    inline blst_256_t() {}
    inline blst_256_t(const uint32_t *p) {} // fake constructor
    ...
    // fake inverse: add host api to pass compilation
    inline blst_256_t inverse(){
        return val;
    }
